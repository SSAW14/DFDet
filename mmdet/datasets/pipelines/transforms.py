...
class Corrupt(object):
    ...
    def __init__(self, corruption, severity=1):
        ...
        self.corruption_lib = ['gaussian_noise', 'shot_noise', 'impulse_noise', 'defocus_blur',
    ...
    def __call__(self, results):
        ...
        if random.randint(0,10) < 4:
            if self.corruption == 'random':
                corruption_method = self.corruption_lib[random.randint(0,18)]
                severity_num = random.randint(1,6)
                results['img'] = corrupt(
                    results['img'].astype(np.uint8),
                    corruption_name=corruption_method,
